...
public class APerpendicularTool extends AnalTool{

    public APerpendicularTool(Block ac){
        super(ac);
        ncount = 2;
    ...
    public void draw(Canvas g){
        ...
        _ac._cvm.drawLine(g,x,0,x,y2, at_col ,1.0f);
        _ac._cvm.drawLine(g,x1,0,x1,y2, at_col ,1.0f);
