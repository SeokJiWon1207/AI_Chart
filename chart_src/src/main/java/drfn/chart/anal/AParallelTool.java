...
public class AParallelTool extends AnalTool{

    public AParallelTool(Block ac){
        super(ac);
        ncount = 2;
    ...
    public void draw(Canvas g){
        ...
        _ac._cvm.drawLine(g,0,y,x2,y, at_col ,1.0f);
        _ac._cvm.drawLine(g,0,y1,x2,y1, at_col ,1.0f);
