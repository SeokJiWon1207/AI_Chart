...
public class AChuseLineTool extends AnalTool{
    ...
    public AChuseLineTool(Block ac){
        super(ac);
        ncount = 2;
    ...
    public void draw(Canvas g){
        ...
        double price = data[1].y;
        double prePrice = data[0].y;
        if(x>=x1)
        {
            price = data[0].y;
            prePrice = data[1].y;
        ...
        if(x<x1)
        {
            ...
            drawSelectedPointData(g,(int)x1,(int)y1,xIndex1,""+data[1].y, strChgrate);
        }
        else
        {
            drawSelectedPointData(g,(int)x,(int)y,xIndex,""+data[0].y, strChgrate);
