...
public class ParabolicSARGraph extends AbstractGraph{
	...
	public ParabolicSARGraph(ChartViewModel cvm, ChartDataModel cdm){
		super(cvm,cdm);
...
//		}
	...
	public void drawGraph(Canvas gl){
		...
		t.plot(gl,drawData);
//        if(base!=null){
//            for(int i=0;i<base.length;i++)t.draw(gl,base[i]);
//        }
...
//        return c;
//    }
//    private double SARMAX(double a,double b,double c){
//        double d=((a>=b) ? (a>=c ? a : c) : (b>=c ? b : c));
//        return d;
//    }
//    private double SARMIN(double a,double b,double c){
//        double d=((a<=b) ? (a<=c ? a : c) : (b<=c ? b : c));
//        return d;
//    }
