 ...
 * 가격 이동평균 그래프
 */
public class GoldenDeadCrossMA_EMASignal extends AbstractGraph{
	int[][] data;
	String[] datakind = {"종가"};
	int m_dataCnt;
	public GoldenDeadCrossMA_EMASignal(ChartViewModel cvm, ChartDataModel cdm){
		super(cvm,cdm);
