...
public class SonarMomentumSignalSignal extends AbstractGraph{
    ...
    double[] sonar;
    double[] sonar_ma;
    public SonarMomentumSignalSignal(ChartViewModel cvm, ChartDataModel cdm){
        super(cvm,cdm);
...
//        }
        ...
        for(int i=0;i<tool.size();i++){
            ...
            if(i==0){
                ...
                double[] signalData = exponentialAverage(sonar,interval[2]);
...
//    }
    ...
    public String getName(){
        if(m_nStrategyType == 1)
            return "SonarMomentumSignal강세약세";
        else
            return "SonarMomentumSignal신호";
    }
}